...
$details = trim(filter_input(INPUT_POST,"details",FILTER_SANITIZE_SPECIAL_CHARS));
    ...
    if($name == "" || $email == "" || $category == "" || $title == ""){
        $error_message = "Please fill the required fields: Name,email,category or title";
...
<div class="section page">   
    ...
    <?php if(isset($_GET["status"]) && $_GET["status"] == "thanks"){
        echo    "<p>Thanks for the email &rsquo;ll check out you suggestion shortly</p>";
    }else{if(isset($error_message)){
        echo "<p class='message'>" . $error_message . "</p>";
    }else{
        echo     "<p>
        If you thing there is something I'm missing 
        let me know complete the form to send me an email.
        </p>";
    }?>
    ...
    <form method="post" action="suggest.php">
        <table>
            <tr>
                <th><label id="name">Name (required)</label></th>
                <td><input type="text" name="name" for="name" value="<?php if(isset($name)){
                    echo $name; 
                }?>"/></td> 
            </tr>
            <tr>
                <th><label id="email">Email (required)</label></th>
                <td><input type="text" name="email" for="email" value="<?php if(isset($email)){
                    echo $email; 
                }?>"/></td> 
            </tr>
            <tr>
            ...
            <tr>
                <th><label id="year">Year: </label></th>
                <td><input type="text" name="year" for="year" value="<?php if(isset($year)){
                    echo $year; 
                }?>"/></td> 
            </tr>
            <tr>
            ...
            <tr style="display:none">
                <th><label for="address">Suggest item details</label></th>
